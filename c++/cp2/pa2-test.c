...
hfp		int2hfp_ans[N]		= { 0x3c00,		0xd650,		0x7bff,		0xfc00,		0x7c00,			0xfc00		};

hfp		hfp_in[N]			= { 0x0001,		0x2bff,		0xde8c,		0x8000,		0xffff,			0x7c00		};
int		hfp2int_ans[N]		= { 0,			0,			-419,		0,			0x80000000,		0x80000000	};

float 	float_in[N]			= {	-(0.0/0.0),		3.0/(float)(1<<26),		1.0/(float)(1<<25),		5.0/(float)(1<<28),		3583.0/8.0,		3.0*(float)(1<<16) };
